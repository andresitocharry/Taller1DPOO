...
public void buscarAtletaPorNombre(String nombre)
{
	Pais resultado = null;
	for (Atleta unAtleta : atletas)
	{
	if(unAtleta.darNombre() == nombre) 
	    {
	...
	public String BuscarPaisAtletaPorNombre(String Nombre)
	{	
		String resultado = null;
		Atleta elAtleta = buscarAtleta(Nombre);
		Pais paisDelAtleta = elAtleta.darPais();
		resultado = paisDelAtleta.darNombre();
		return resultado;
	}
