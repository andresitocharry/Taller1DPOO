...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Buscar país de un atleta dado su nombre\n");
	...
	private void ejecutarBuscarAtletaPorNombre() 
	{
		...
		String PaisAtletaBuscado = calculadora.BuscarPaisAtletaPorNombre(Nombre);
		System.out.println("El atleta " + Nombre + " represento al país: " + PaisAtletaBuscado);
	}
